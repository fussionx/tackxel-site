...
import { ArrowRight, ArrowUpRight, ExternalLink, Plus, Minus, Check, Sparkles } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 z-10">
          <Reveal>
            <nav className="flex flex-wrap items-center gap-2 text-xs text-neutral-500 mb-8 font-mono">
              ...
              <span className="text-neutral-300">/</span>
              <Link href="/services/ai-integration" className="hover:text-brand-600 transition-colors">AI Integration</Link>
              <span className="text-neutral-300">/</span>
          ...
          <Reveal>
            <div className="max-w-3xl mb-12">
              ...
              <p className="text-base text-neutral-600 leading-relaxed mt-4 max-w-xl">
                The right tool for the job, chosen on accuracy, latency, and cost — not on what we&apos;re married to.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-[1.3fr_1fr] gap-10 lg:gap-16 items-start">
            ...
            <Reveal delay={200} direction="left">
              <div className="space-y-4">
                ...
                <Link href="/case-studies/lexa" className="group block">
                  <article className="flex items-center gap-4 bg-white border border-neutral-200 rounded-2xl p-4 card-lift">
                    <div className="relative w-20 h-16 rounded-xl overflow-hidden border border-neutral-200 flex-shrink-0">
                      <CaseStudyVisual monogram={lexa.monogram} accent={lexa.accent} />
                    </div>
                    <div className="min-w-0">
                      <div className="text-sm font-semibold text-neutral-950 group-hover:text-brand-600 transition-colors">Lexa</div>
                      <div className="text-xs text-neutral-500 leading-snug">Pakistan&apos;s first AI legal chatbot — live</div>
                    </div>
                ...
                <Link href="/case-studies/my-friend" className="group block">
                  <article className="flex items-center gap-4 bg-white border border-neutral-200 rounded-2xl p-4 card-lift">
                    <div className="relative w-20 h-16 rounded-xl overflow-hidden border border-neutral-200 flex-shrink-0">
                      <CaseStudyVisual monogram={myFriend.monogram} accent={myFriend.accent} />
                    </div>
                    <div className="min-w-0">
                      <div className="text-sm font-semibold text-neutral-950 group-hover:text-brand-600 transition-colors">My Friend</div>
                      <div className="text-xs text-neutral-500 leading-snug">LLM-powered AI companion app</div>
                    </div>
                    <ArrowUpRight className="w-4 h-4 text-neutral-400 group-hover:text-brand-600 transition-colors ml-auto flex-shrink-0" />
                  </article>
                </Link>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Reveal delay={300}>
              <div className="flex flex-wrap gap-3 mt-10 justify-center">
                ...
                <Link href="/services/ai-integration" className="btn-ghost-light">
                  All AI services
                  <ArrowUpRight className="w-4 h-4" />
                </Link>
              </div>
