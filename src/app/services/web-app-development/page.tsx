        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 z-10">
          <Reveal>
            <nav className="flex items-center gap-2 text-xs text-neutral-400 mb-6 font-mono">
              ...
              <span>/</span>
              <span className="text-brand-300">Web App Development</span>
            </nav>
          </Reveal>
            ...
            <div>
              ...
              <Reveal delay={80}>
                <div className="text-eyebrow text-brand-300 uppercase font-semibold tracking-widest mb-4">
                  Build · Scale · Fix Your Web Application
                </div>
              </Reveal>
              ...
              <div className="space-y-3">
                <div className="bg-neutral-900/80 backdrop-blur border border-neutral-800 rounded-lg p-5 flex items-center gap-4 card-lift">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-neutral-400">Web App Development Company by Clutch</div>
                  </div>
                </div>
                ...
                <div className="bg-neutral-900/80 backdrop-blur border border-neutral-800 rounded-lg p-5 flex items-center gap-4 card-lift">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-neutral-400">Full-Stack Developers · SOC 2 · ISO 27001</div>
                  </div>
                </div>
              </div>
            </Reveal>
